...
//
//        let imageClassificationRequest = VNCoreMLRequest(model: DrawingPredictor.imageClassifier,
    ...
    init(url: URL) {
        ...
        if let imageSource = imageSource, CGImageSourceGetType(imageSource) != nil {
            ...
            if let thumbnailRef = CGImageSourceCreateThumbnailAtIndex(imageSource, 0, options as CFDictionary) {
                thumbnail = UIImage(cgImage: thumbnailRef)
            }
        }
...
//            print("No results or error in processing")
//            return
//        }
//
//        print("Predicted: \(topResult.identifier) with confidence \(topResult.confidence)")
//    }
//
...
//}
//
//// Call this function with your UIImage
//// e.g., predictImageContent(image: yourImage)
//
